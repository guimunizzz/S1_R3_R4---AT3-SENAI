...
- O projeto possui script de teste padrao do npm, sem testes automatizados (Jest/Mocha).
- O foco de validacao esta concentrado na camada de Models (POO).
- O total do pedido e atualizado ao criar/editar item de pedido.
- Em Products, a imagem e obrigatoria pela validacao do model.
...
- Implementar autenticacao/autorizacao (JWT).
- Melhorar padronizacao de respostas e tratamento global de erros.
